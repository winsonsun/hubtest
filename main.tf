...
resource "aws_lightsail_static_ip_attachment" "app" {
  static_ip_name = aws_lightsail_static_ip.static_ip_120.id
  instance_name  = aws_lightsail_instance.app.id
}

resource "aws_lightsail_static_ip" "static_ip_120" {
  name = "StaticIp-120"
}
...
output "instance_static_ip" {
  value = aws_lightsail_static_ip.static_ip_120.ip_address
}
